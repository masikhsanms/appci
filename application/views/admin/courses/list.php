			...
			<div class="container-fluid px-4">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/ccourse/add') ?>"><i class="fas fa-plus"></i> Add New</a>
					</div>
					<div class="card-body">
							...
							<table class="table table-hover dttb" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="250">
											<a href="<?php echo site_url('admin/ccourse/edit/'.$row->id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('admin/ccourse/delete/'.$row->id) ?>')"
